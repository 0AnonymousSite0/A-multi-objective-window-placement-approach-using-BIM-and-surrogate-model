...
def MaximumTemperatureTransformation(ifc_file_path, idf_file_path):
    ...
    property_name = "MaximumTemperature"
    property_value = extract_property_value_from_ifc(ifc_file_path, property_name)

    if property_value is not None:
        replace_value_in_idf_near_marker(idf_file_path, "!- Maximum Heating Supply Air Temperature {C}", property_value)
    else:
        print("Property not found in IFC file.")

ifc_file_path = r'path of ifc file'
idf_file_path = r'path of idf file'
MaximumTemperatureTransformation(ifc_file_path, idf_file_path)
