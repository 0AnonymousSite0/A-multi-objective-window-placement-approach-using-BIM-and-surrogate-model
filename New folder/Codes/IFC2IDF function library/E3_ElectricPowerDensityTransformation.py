...
def ElectricPowerDensityTransformation(ifc_file_path, idf_file_path):
    ...
    def replace_value_in_idf_near_marker(idf_file_path, marker, lines_below_marker, new_value):
        ...
        if marker_index and marker_index < len(lines):
